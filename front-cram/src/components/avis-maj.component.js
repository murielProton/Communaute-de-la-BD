...
export default class MajAvis extends Component {
    ...
    componentDidMount() { // Permet de récupérer les données de l'avis à modifier afin de les avoir dans le formulaire en valeurs par défaut
        api.get('avis/prendrecontenu/' + this.props.match.params.id)
            .then(res => {
    ...
    render() {
        ...
        if (this.state.redirection) {
            //Redirect to the page
               ...
               return <Redirect to={`/bd/detail/${this.props.match.params.id_bd}`}/>;
           }
