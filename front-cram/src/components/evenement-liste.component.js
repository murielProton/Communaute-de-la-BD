...
export default class ListeEvenements extends Component {
                ...
                <table className="table table-striped" style={{ marginTop: 20 }} >
                    ...
                    {evenements.map(evenement =>( //nous parcourons la liste des tâches à faire en utilisant la fonction de carte. Chaque élément de tâche est généré à l'aide du composant Todo qui n'est pas encore implémenté. L'élément de tâche actuel est affecté à la propriété de tâche de ce composant.
                        <tr>
                            ...
                            <div>
                                <td><Link to={"/evenement/maj/"+ evenement._id} className="btn btn-info">Modifier l'evenement</Link></td>
                                <td><Link to={"/evenement/supprimer/"+evenement._id+"/"+evenement.nom} className="btn btn-danger">Supprimer</Link></td>
                            </div>
                            }
                            {evenement.cree_par !== this.state.cookies.get('Session') &&
                            <div>
