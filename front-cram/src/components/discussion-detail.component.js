...
import api from '../api';
// import CreationMessage from './message-creation.component';

export default class DetailDiscussion extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            discussions: [],
    ...
    render() {
        ...
        return (
            <div class="container">
                <div>
                <Link to={"/discussion/creer"} className="btn btn-info" >Revenir aux discussions</Link>
            ...
            {discussions.map(discussion => (
                <div>
                    ...
                    <div className="card">
                        ...
                        {this.state.cookies.get('Session') === message.pseudo &&
